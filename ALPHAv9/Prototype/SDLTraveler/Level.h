...
public:
	...
	Level(SDL_Renderer* pRend, const char* bgName, int MAXEYES, int MAXGOOMS, int platX[], int platY[])
	{
		...
		SDL_QueryTexture(backGround, NULL, NULL, &levelWidth, &levelHeight); // get's the height and width of the sdl surface background thats been converted into an sdl texture
	}
